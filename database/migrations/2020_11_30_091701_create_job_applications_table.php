...
class CreateJobApplicationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('job_applications', function (Blueprint $table) {
            ...
            $table->string('skill6',50)->nullable();
            $table->tinyInteger('eval6')->nullable();
            $table->string('sremarks6')->nullable();
            $table->tinyInteger('exp6')->nullable();
            $table->string('skill7',50)->nullable();
            $table->tinyInteger('eval7')->nullable();
            $table->string('sremarks7')->nullable();
            $table->tinyInteger('exp7')->nullable();
            $table->string('skill8',50)->nullable();
            $table->tinyInteger('eval8')->nullable();
            $table->string('sremarks8')->nullable();
            $table->tinyInteger('exp8')->nullable();
            $table->string('skill9',50)->nullable();
            $table->tinyInteger('eval9')->nullable();
            $table->string('sremarks9')->nullable();
            $table->tinyInteger('exp9')->nullable();
            $table->string('skill10',50)->nullable();
            $table->tinyInteger('eval10')->nullable();
            $table->string('sremarks10')->nullable();
            $table->tinyInteger('exp10')->nullable();
