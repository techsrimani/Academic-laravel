...
class JobApplicationRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'skills1' => 'required|max:190',
            'contribution1' => 'required|numeric|max:100',
            'link2' => 'max:150',
            'your_role2' => 'max:50',
            'skills2' => 'max:190',
            'contribution2' => 'nullable|numeric|max:100',
            'link3' => 'max:150',
            'your_role3' => 'max:50',
            'skills3' => 'max:190',
            ...
            'skill6' => 'max:190',
            'eval6' => 'nullable|numeric|max:10',
            'sremarks6' => 'max:190',
            'exp6' => 'nullable|numeric|max:30',
            'skill7' => 'max:190',
            'eval7' => 'nullable|numeric|max:10',
            'sremarks7' => 'max:190',
            'exp7' => 'nullable|numeric|max:30',
            'skill8' => 'max:190',
            'eval8' => 'nullable|numeric|max:10',
            'sremarks8' => 'max:190',
            'exp8' => 'nullable|numeric|max:30',
            'skill9' => 'max:190',
            'eval9' => 'nullable|numeric|max:10',
            'sremarks9' => 'max:190',
            'exp9' => 'nullable|numeric|max:30',
            'skill10' => 'max:190',
            'eval10' => 'nullable|numeric|max:10',
            'sremarks10' => 'max:190',
            'exp10' => 'nullable|numeric|max:30',
